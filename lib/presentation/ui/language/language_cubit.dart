...
class LanguageCubit extends Cubit<LanguageState> {
  ...
  Map<String, Object> textAr = {
    ...
    'needPoints2': ' نقطة وانت لا تملك نقاط كافية لتنفيذ الرحلة من فضلك اشتري نقاط اضافية وعاود المحاولة مره اخري',
    ...
    'subTitle1': 'اعمل بمرونة واكسب المال. قم بالتسجيل والانضمام إلى مجموعتنا الواسعة من السائقين المهرة ومتعددي اللغات.',
    'title2': 'سلامتك اولوية',
    'subTitle2': 'نحن ملتزمون بدورنا وسلامتك هي مسؤوليتنا. نستخدم التكنولوجيا لتحقيق مستويات عالية من الامان. اصبح من السهل علي جميع التنقل.',
    'title3': 'كن شريكاً',
  ...
  Map<String, Object> textEn = {
    ...
    'egp': 'EGP',
    'optTrip': 'Enter two-step verification code has been sent to the client to start the trip',
    'lang': 'Language',
    'Arabic': 'Arabic',
    'English': 'English',
    'brief': 'Brief',
    ...
    'needPoints2': ' points and you do not have enough points to carry out the trip.\n Please buy additional points and try again',
    ...
    'subTitle1': 'Work with flexibility and earn money. Sign up and join our wide range of skilled and multilingual drivers.',
    'title2': 'Your safety is a priority',
    'subTitle2': 'We are committed to our and safety is a main concern. We use technology to achieve high levels of safety. it became easier for everyone to get around.',
    'title3': 'Be our partner',
    'subTitle3': 'You are our success partners. Serving you and feeling with your satisfaction is a goal for us.',
    'title4': 'Enjoy Trip',
