...
class RequestDetailsRepositoryImpl extends RequestDetailsRepository {
  ...
  RequestDetailsRepositoryImpl(this.requestDetailsRemoteDataSource, this.networkInfo);

  @override
  Future<Either<String, DataRequest?>> getRequestDetails(String id) async{
    if (await networkInfo.isConnected) {
      return await requestDetailsRemoteDataSource.getRequestDetails(id).then((value) {
